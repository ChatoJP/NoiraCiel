  ...
  return (
    <section id="newsletter" className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto text-center relative">
        ...
        <p className="font-body text-xs tracking-[0.35em] text-noir-gold/60 uppercase mb-6">Stay Close</p>
        ...
        <p className="font-body text-sm text-noir-silver/60 mb-12 leading-relaxed max-w-md mx-auto">
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              required
              className="flex-1 px-5 py-3.5 bg-noir-deep/60 border border-noir-silver/20 text-noir-ivory font-body text-sm placeholder-noir-silver/30 focus:outline-none focus:border-noir-gold/40 transition-colors"
            />
            <button
              type="submit"
              disabled={status === 'loading'}
              className="px-8 py-3.5 bg-noir-gold/10 border border-noir-gold/50 text-noir-gold font-body text-xs tracking-[0.2em] uppercase hover:bg-noir-gold hover:text-noir-void transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {status === 'loading' ? (
        ...
        <p className="font-body text-[10px] text-noir-silver/25 mt-6 tracking-wide">
