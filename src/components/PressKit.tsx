    ...
    <section id="press" className="py-24 px-6 bg-gradient-to-b from-transparent to-noir-deep/30">
      <div className="max-w-5xl mx-auto">
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <p className="font-body text-xs tracking-[0.35em] text-noir-gold/65 uppercase mb-4">Media</p>
            <h2 className="font-heading text-5xl md:text-6xl text-noir-ivory font-light tracking-wide">
              Press Kit
            </h2>
          </div>
          <p className="font-body text-sm text-noir-silver/60 max-w-xs">
          ...
          {assets.map((asset) => (
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <span className="font-body text-[9px] tracking-[0.2em] text-noir-silver/45 border border-noir-silver/20 px-1.5 py-0.5">
                  {asset.ext}
                </span>
              </div>
              <p className="font-heading text-base text-noir-ivory mb-2">{asset.title}</p>
              <p className="font-body text-xs text-noir-silver/60">{asset.description}</p>

              <a
                href="#contact"
                className="mt-6 flex items-center gap-2 font-body text-xs text-noir-silver/40 group-hover:text-noir-gold/70 transition-colors"
              >
        ...
        <div className="mt-12 p-6 border border-noir-silver/10 bg-noir-deep/20">
          <p className="font-body text-sm text-noir-silver/65">
