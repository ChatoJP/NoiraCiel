...
export const PATHS: NoiraCielPath[] = [
  {
    ...
    physicsAffinity: ['fields', 'entanglement', 'time'],
  ...
  },
  {
    ...
    physicsAffinity: ['resonance', 'interference', 'symmetry'],
  ...
  },
  {
    ...
    physicsAffinity: ['tunnelling', 'symmetry', 'collapse'],
  ...
  },
  {
    ...
    physicsAffinity: ['uncertainty', 'superposition', 'wavefunction'],
  ...
  },
  {
    ...
    physicsAffinity: ['resonance', 'wavefunction', 'fields'],
  ...
  },
  {
    ...
    physicsAffinity: ['decoherence', 'entropy', 'light'],
